...
public class DepartmentListController implements Initializable, DataChangeListener {
   ...
   private void removeEntity(Department obj) {
    ...
    Optional<ButtonType> result = Alerts.showConfirmation("Confirmation", "Tem certeza que desja deletar?");
    ...
    if(result.get() == ButtonType.OK){
        ...
        try{
            ...
            Alerts.showAlert("Error removing", null, e.getMessage(), Alert.AlertType.ERROR);
